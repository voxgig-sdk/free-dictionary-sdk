...
AQL-driven CLI and REPL for the FreeDictionary SDK. Positional arguments are
...
```sh
go build -o free-dictionary-cli ./...
```
...
./free-dictionary-cli load 1 entry
./free-dictionary-cli load '{id:1}' entry
