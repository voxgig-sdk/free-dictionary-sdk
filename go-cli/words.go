...
func registerSDKWords(r *eng.Registry, client *sdk.FreeDictionarySDK) {
...
func runOp(client *sdk.FreeDictionarySDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
