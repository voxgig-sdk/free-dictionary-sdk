...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/free-dictionary` | `npm install @voxgig-sdk/free-dictionary` |
| Python | `voxgig-sdk-free-dictionary` | `pip install voxgig-sdk-free-dictionary` |
| PHP | `voxgig-sdk/free-dictionary` | `composer require voxgig-sdk/free-dictionary` |
| Golang | `github.com/voxgig-sdk/free-dictionary-sdk/go` | `go get github.com/voxgig-sdk/free-dictionary-sdk/go` |
| Ruby | `voxgig-sdk-free-dictionary` | `gem install voxgig-sdk-free-dictionary` |
| Lua | `voxgig-sdk-free-dictionary` | `luarocks install voxgig-sdk-free-dictionary` |
