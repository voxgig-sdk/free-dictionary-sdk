...
|---|---|---|
| `ts/` | @voxgig-sdk/free-dictionary-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/free-dictionary-sdk \
      --repository voxgig-sdk/free-dictionary-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/free-dictionary-sdk` shows it, and
`npm trust revoke @voxgig-sdk/free-dictionary-sdk --id=<id>` removes it.
