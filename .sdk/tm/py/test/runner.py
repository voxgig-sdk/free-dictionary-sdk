...
class FreeDictionaryTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeDictionaryTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = FreeDictionaryTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = FreeDictionaryTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
