...
class FreeDictionaryTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeDictionaryTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = FreeDictionaryTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = FreeDictionaryTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
