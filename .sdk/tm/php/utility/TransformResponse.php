...
// FreeDictionary SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FreeDictionaryTransformResponse
{
    public static function call(FreeDictionaryContext $ctx): mixed
    {
        ...
        $transform = FreeDictionaryHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
