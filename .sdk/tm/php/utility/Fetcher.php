...
// FreeDictionary SDK utility: fetcher

class FreeDictionaryFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FreeDictionarySDK/1.0)';
    ...
    public static function call(FreeDictionaryContext $ctx, string $fullurl, array $fetchdef): array
    {
