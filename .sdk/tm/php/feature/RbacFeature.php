...
// FreeDictionary SDK rbac feature
...
class FreeDictionaryRbacFeature extends FreeDictionaryBaseFeature
{
    ...
    private function _required(FreeDictionaryContext $ctx): ?string
    {
    ...
    private function _reject(FreeDictionaryContext $ctx, string $required): void
    {
    ...
    private function _track(FreeDictionaryContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
