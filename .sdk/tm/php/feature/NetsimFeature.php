...
// FreeDictionary SDK netsim feature
...
class FreeDictionaryNetsimFeature extends FreeDictionaryBaseFeature
{
    ...
    private function _simulate(FreeDictionaryContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FreeDictionaryContext $ctx, array $applied): void
    {
        $client = $this->client;
