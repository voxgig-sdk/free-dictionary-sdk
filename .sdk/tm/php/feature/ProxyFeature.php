...
// FreeDictionary SDK proxy feature
...
class FreeDictionaryProxyFeature extends FreeDictionaryBaseFeature
{
    ...
    public function init(FreeDictionaryContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FreeDictionaryContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
