...
// FreeDictionary SDK timeout feature
...
class FreeDictionaryTimeoutFeature extends FreeDictionaryBaseFeature
{
    ...
    private function _with_timeout(FreeDictionaryContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FreeDictionaryContext $_ctx, float $ms): void
    {
        $client = $this->client;
