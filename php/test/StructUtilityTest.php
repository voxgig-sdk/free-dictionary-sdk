...
// FreeDictionary SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FreeDictionaryOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FreeDictionaryOmni::structfix($now, Struct::undef()))
                        !== json_encode(FreeDictionaryOmni::structfix($val, Struct::undef()))) {
