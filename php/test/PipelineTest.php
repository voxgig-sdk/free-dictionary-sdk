...
// FreeDictionary SDK pipeline test
//
...
require_once __DIR__ . '/../freedictionary_sdk.php';
...
{
    private static function utility(): FreeDictionaryUtility
    {
        return new FreeDictionaryUtility();
    }
    ...
    private static function ctx(array $over = []): FreeDictionaryContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new FreeDictionaryContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new FreeDictionaryOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof FreeDictionaryError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new FreeDictionaryOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = FreeDictionaryMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new FreeDictionaryOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = FreeDictionaryMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new FreeDictionaryOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = FreeDictionaryMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FreeDictionarySpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = FreeDictionaryMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new FreeDictionaryResponse([]),
            'result' => new FreeDictionaryResult([]),
        ]);
        [, $err] = FreeDictionaryMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new FreeDictionarySpec([]),
            'response' => null,
            'result' => new FreeDictionaryResult([]),
        ]);
        [, $err] = FreeDictionaryMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new FreeDictionarySpec(['step' => 's']),
            'response' => new FreeDictionaryResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new FreeDictionaryResult([]),
        ]);
        [, $err] = FreeDictionaryMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new FreeDictionarySpec(['step' => 's']),
            'response' => new FreeDictionaryResponse(self::resp(200, ['v' => 1])),
            'result' => new FreeDictionaryResult([]),
        ]);
        [, $err] = FreeDictionaryMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new FreeDictionarySpec(['step' => 's']),
            'response' => new FreeDictionaryResponse(self::resp(200, ['v' => 2])),
            'result' => new FreeDictionaryResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        FreeDictionaryMakeResponse::call($ctx);
    ...
    {
        $preset = new FreeDictionaryResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new FreeDictionarySpec([]),
            'response' => new FreeDictionaryResponse([]),
            'result' => new FreeDictionaryResult([]),
        ...
        [$got, $err] = FreeDictionaryMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new FreeDictionaryResult([])]);
        [, $err] = FreeDictionaryMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new FreeDictionarySpec([]), 'result' => null]);
        [, $err] = FreeDictionaryMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FreeDictionarySpec(['step' => 's']),
            'result' => new FreeDictionaryResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new FreeDictionaryOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FreeDictionaryMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FreeDictionarySpec(['step' => 's']),
            'result' => new FreeDictionaryResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new FreeDictionaryOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FreeDictionaryMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FreeDictionaryResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new FreeDictionarySpec([]),
            'result' => new FreeDictionaryResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = FreeDictionaryMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FreeDictionaryMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new FreeDictionaryError('boom', 'boom');
        $utility->fetcher = function (FreeDictionaryContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FreeDictionarySpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = FreeDictionaryMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (FreeDictionaryContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = FreeDictionaryMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(FreeDictionaryResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        FreeDictionaryMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (FreeDictionaryContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FreeDictionarySpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = FreeDictionaryMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new FreeDictionaryResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new FreeDictionarySpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = FreeDictionaryMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = FreeDictionaryMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = FreeDictionaryMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new FreeDictionaryResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, FreeDictionaryDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new FreeDictionaryResult(['ok' => false])]);
        $this->expectException(FreeDictionaryError::class);
        FreeDictionaryDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new FreeDictionaryResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', FreeDictionaryMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        FreeDictionaryMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new FreeDictionaryBaseFeature();
        $b = new FreeDictionaryBaseFeature();
        FreeDictionaryFeatureAdd::call($ctx, $a);
        FreeDictionaryFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): FreeDictionaryBaseFeature
    {
        $f = new FreeDictionaryBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        FreeDictionaryFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): FreeDictionaryContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new FreeDictionarySpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FreeDictionaryPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        FreeDictionaryPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new FreeDictionaryResponse(['headers' => null]),
            'result' => new FreeDictionaryResult([]),
        ]);
        FreeDictionaryResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        FreeDictionaryResultBody::call($ctx);
