...
// FreeDictionary SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FreeDictionarySDK::test)
...
{
    private const SDK_CLASS = 'FreeDictionarySDK';
    ...
    private const SDK_BASE = 'freedictionary_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../freedictionary_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
