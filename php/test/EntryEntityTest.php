...
class EntryEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set FREE_DICTIONARY_TEST_ENTRY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function entry_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("FREE_DICTIONARY_TEST_ENTRY_ENTID");
