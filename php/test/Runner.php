...
class FreeDictionaryTestRunner
{
    ...
    {
        $live = self::getenv('FREE_DICTIONARY_TEST_LIVE');
        $override = self::getenv('FREE_DICTIONARY_TEST_OVERRIDE');
        ...
        $explain = self::getenv('FREE_DICTIONARY_TEST_EXPLAIN');
...
class_alias('FreeDictionaryTestRunner', 'Runner');
class_alias('FreeDictionaryHelpers', 'Helpers');
