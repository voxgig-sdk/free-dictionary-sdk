...
// FreeDictionary SDK utility: graphql
//
...
class FreeDictionaryGraphql
{
    ...
    // equivalent.
    public static function body(FreeDictionaryContext $ctx): mixed
    {
    ...
    public static function errors(FreeDictionaryContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
