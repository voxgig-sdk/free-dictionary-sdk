...
// FreeDictionary SDK utility type

class FreeDictionaryUtility
{
    ...
    public static function copy(FreeDictionaryUtility $src): FreeDictionaryUtility
    {
        $u = new FreeDictionaryUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
