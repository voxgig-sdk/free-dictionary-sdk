...
// FreeDictionary SDK cache feature
...
class FreeDictionaryCacheFeature extends FreeDictionaryBaseFeature
{
    ...
    private function _through(FreeDictionaryContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
