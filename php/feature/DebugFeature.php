...
// FreeDictionary SDK debug feature
...
class FreeDictionaryDebugFeature extends FreeDictionaryBaseFeature
{
    ...
    private function _finish(FreeDictionaryContext $ctx, bool $ok): void
    {
