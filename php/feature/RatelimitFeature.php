...
// FreeDictionary SDK ratelimit feature
...
class FreeDictionaryRatelimitFeature extends FreeDictionaryBaseFeature
{
    ...
    private function _acquire(FreeDictionaryContext $ctx): void
    {
    ...
    private function _track(FreeDictionaryContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
