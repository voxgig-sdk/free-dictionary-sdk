...
// FreeDictionary SDK telemetry feature
...
class FreeDictionaryTelemetryFeature extends FreeDictionaryBaseFeature
{
    ...
    private function _close(FreeDictionaryContext $ctx, bool $ok): void
    {
