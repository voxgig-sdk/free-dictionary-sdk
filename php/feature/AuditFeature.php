...
// FreeDictionary SDK audit feature
...
class FreeDictionaryAuditFeature extends FreeDictionaryBaseFeature
{
    ...
    private function _emit(FreeDictionaryContext $ctx, string $outcome): void
    {
