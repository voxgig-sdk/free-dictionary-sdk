...
// FreeDictionary SDK metrics feature
...
class FreeDictionaryMetricsFeature extends FreeDictionaryBaseFeature
{
    ...
    private function _record(FreeDictionaryContext $ctx, bool $ok): void
    {
