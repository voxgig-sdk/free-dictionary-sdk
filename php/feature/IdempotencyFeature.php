...
// FreeDictionary SDK idempotency feature
...
class FreeDictionaryIdempotencyFeature extends FreeDictionaryBaseFeature
{
    ...
    private function _mutating(FreeDictionaryContext $ctx): bool
    {
