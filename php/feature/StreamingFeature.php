...
// FreeDictionary SDK streaming feature
...
class FreeDictionaryStreamingFeature extends FreeDictionaryBaseFeature
{
    ...
    private function _iterate(FreeDictionaryResult $result): \Generator
    {
    ...
    private function _streamable(FreeDictionaryContext $ctx): bool
    {
