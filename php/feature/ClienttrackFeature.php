...
// FreeDictionary SDK clienttrack feature
...
class FreeDictionaryClienttrackFeature extends FreeDictionaryBaseFeature
{
    ...
    public function PostConstruct(FreeDictionaryContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FreeDictionary-SDK';
