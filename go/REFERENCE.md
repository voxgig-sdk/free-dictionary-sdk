# FreeDictionary Golang SDK Reference

Complete API reference for the FreeDictionary Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *FreeDictionarySDK`
...
#### `Entry(data map[string]any) FreeDictionaryEntity`
