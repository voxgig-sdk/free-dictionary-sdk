...
function runner.env_override(m)
  local live = runner.getenv("FREEDICTIONARY_TEST_LIVE")
  local override = runner.getenv("FREEDICTIONARY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FREEDICTIONARY_TEST_EXPLAIN")
