# FreeDictionary SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FreeDictionarySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FreeDictionarySDK(...) and FreeDictionarySDK.test(...) become
#      FreeDictionarySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "freedictionary_sdk"
_SDK_CLASS = "FreeDictionarySDK"
