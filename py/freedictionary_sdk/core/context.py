...
from freedictionary_sdk.core.control import FreeDictionaryControl
...
from freedictionary_sdk.core.helpers import get_ctx_prop, to_map
...
class FreeDictionaryContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = FreeDictionaryControl()
        ...
        if isinstance(sp, FreeDictionarySpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FreeDictionaryResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FreeDictionaryResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return FreeDictionaryOperation({})
    ...
    def make_error(self, code, msg):
        return FreeDictionaryError(code, msg, self)
