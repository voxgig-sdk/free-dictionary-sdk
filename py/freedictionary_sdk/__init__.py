...
from freedictionary_sdk.utility import register

# Load features
from freedictionary_sdk.feature.base_feature import FreeDictionaryBaseFeature
from freedictionary_sdk.features import _has_feature, _make_feature
...
class FreeDictionarySDK:
    ...
    def __init__(self, options=None):
        ...
        utility = FreeDictionaryUtility()
        self._utility = utility

        from freedictionary_sdk.config import shared_config
    ...
    def get_utility(self):
        return FreeDictionaryUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FreeDictionarySDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Entry(self, data=None) -> "EntryEntity":
        ...
        from freedictionary_sdk.entity.entry_entity import EntryEntity
