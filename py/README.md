...
The Python SDK for the FreeDictionary API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/free-dictionary-sdk/releases)) or
