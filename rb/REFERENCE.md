# FreeDictionary Ruby SDK Reference

Complete API reference for the FreeDictionary Ruby SDK.
...
#### `FreeDictionarySDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.Entry.list(nil)
```
