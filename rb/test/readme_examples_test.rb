...
#      offline in seeded test mode (FreeDictionarySDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "FreeDictionary_sdk.rb")
  SDK_CLASS = "FreeDictionarySDK"
