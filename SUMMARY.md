...
Results: Successful response with word definitions.
...
| --- | --- | --- | --- |
| Entry | `list` | `GET /entries/{language}/{word}` | See reference |

## Connect to the API

- Production server: `https://api.dictionaryapi.dev/api/v2`
...
- `free-dictionary_list`: List records for an entity. Supported entities: `entry`.
- `free-dictionary_load`: Load one record for an entity. No active entity supports this operation.
