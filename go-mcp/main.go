// Command FreeDictionary-mcp is an MCP server exposing the FreeDictionary
// SDK as MCP tools.
//
// Two tools are registered:
//
//	FreeDictionary_list  — list records of an entity
//	FreeDictionary_load  — load a single record of an entity
//
