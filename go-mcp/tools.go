...
func registerTools(server *mcp.Server, client *sdk.FreeDictionarySDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-dictionary_list",
		Description: "List records from FreeDictionary. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-dictionary_load",
		Description: "Load a single record from FreeDictionary. " +
...
func runOp(client *sdk.FreeDictionarySDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FreeDictionarySDK, name string) (sdk.FreeDictionaryEntity, error) {
