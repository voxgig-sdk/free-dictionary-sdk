...
function envOverride(m) {
    if ('TRUE' === process.env.FREE_DICTIONARY_TEST_LIVE ||
        'TRUE' === process.env.FREE_DICTIONARY_TEST_OVERRIDE) {
    ...
    m.FREE_DICTIONARY_TEST_EXPLAIN = process.env.FREE_DICTIONARY_TEST_EXPLAIN || m.FREE_DICTIONARY_TEST_EXPLAIN;
    return m;
}
