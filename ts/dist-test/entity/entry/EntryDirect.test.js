...
(0, node_test_1.describe)('EntryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.FreeDictionarySDK({
    ...
    (0, node_test_1.test)('direct-list-entry', async (t) => {
        ...
        if (setup.live) {
            ...
            params.word = setup.idmap['word01'];
        }
        else {
...
function liveScenariosActive() { return false && process.env.FREE_DICTIONARY_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.FreeDictionarySDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['FREE_DICTIONARY_TEST_ENTRY_ENTID'];
    ...
    const client = new __1.FreeDictionarySDK({
        base: 'http://localhost:8080',
